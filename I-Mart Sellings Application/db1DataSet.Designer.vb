...
Namespace db1DataSetTableAdapters
    ...
    Partial Public Class Table1TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT [Item ID], [Customer Name], [Mobile Number], Address, [Items Cost], [Selli"& _ 
                "ng Price], [Items Ordered], Postages, Profit, [Photos of Ordered Items], [Links "& _ 
                "of Ordered Items], [Ordered Date], [Payment Method], [Advertised By], [Sent Date"& _ 
                "], [Received Date], [Actual Photos of Items], [Ebay Order PDF] FROM Table1"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As db1DataSet.Table1DataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As db1DataSet.Table1DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As db1DataSet.Table1DataTable = New db1DataSet.Table1DataTable
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As db1DataSet.Table1DataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As db1DataSet.Table1DataTable) As Integer
